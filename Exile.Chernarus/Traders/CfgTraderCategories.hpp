class CfgTraderCategories
{
	...
	class AmmunitionCUP
	{
		...
		items[] =
		{
			...
			//"CUP_20Rnd_B_AA12_HE", DON'T SELL AT TRADERS
	...
	class SpecialExplosives
	{
		name = "Special Explosives";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\CargoMag_ca.paa";
		items[] =
		{
			"ATMine_Range_Mag",
