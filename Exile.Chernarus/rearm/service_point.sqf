...
//====================== general settings
_folder = "rearm\"; // folder where the service point scripts are saved, relative to the mission file
//_servicePointClasses = ["StorageBladder_02_water_sand_F", "Land_A_FuelStation_Feed"]; // service point classes (can be house, vehicle and unit classes)
_servicePointClasses = ["Land_Device_assembled_F"];
...
_rearm_costs = [ 
		...
		["B_Heli_Light_01_Armed_F",8000],
		["O_Heli_Light_02_F",8000],
		["I_Heli_Light_03_F",8000],
		["B_Heli_Transport_01_F",8000],
        ["AllVehicles",5000],
        ["Air",8000]
];
