 ...
 */
#include "Traders\ExileArsenal.hpp"
...
class CfgExileEnvironment
{
	...
	class Chernarus : Altis
	{
		...
		class Temperature
		{
			// Temperature in °C for the time of day, per hour
			// Add the first index to the last index, so it is 25 indizes!
			daytimeTemperature[] = { 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23 };
...
class CfgExileLootSettings
{
	...
	maximumPositionCoverage = 100;
 	 ...
 	 * cap this at 10
 	 */
	maximumNumberOfLootSpotsPerBuilding = 100;
